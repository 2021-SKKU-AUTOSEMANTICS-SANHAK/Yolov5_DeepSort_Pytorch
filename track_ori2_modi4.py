...
def re_identification(return_dict1, return_dict2, ids_per_frame1_list, ids_per_frame2_list, video_get1, video_get2):
    ...
    while True:
        ...
        for i in len(heatmaplist1):
            background_image = cv2.imread("struct2.JPG")
...
if __name__ == '__main__':
    ...
    #reid = REID()
    video1 = ['/content/drive/MyDrive/Yolov5_DeepSort_Pytorch/test_video_Trim.mp4']
    video2 = ['/content/drive/MyDrive/Yolov5_DeepSort_Pytorch/test_video_Trim.mp4']
